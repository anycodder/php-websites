            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/about" class=" <?= $_SERVER['REQUEST_URI'] == '/about' ?  'rounded-md bg-gray-900'  : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                        <a href="/notes" class=" <?= $_SERVER['REQUEST_URI'] == '/notes' ?  'rounded-md bg-gray-900'  : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Notes</a>
                        <a href="/contact" class=" <?= $_SERVER['REQUEST_URI'] == '/contact' ?  'rounded-md bg-gray-900'  : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
